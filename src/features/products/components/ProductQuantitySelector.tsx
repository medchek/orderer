...
const QuantityButton = ({
  ...
  return (
    <button
      className="size-8 rounded-md active:text-white dark:bg-neutral-900 active:dark:bg-neutral-700"
      type="button"
      onClick={onClick}
    >
      {add ? (
    ...
    <div className="flex h-8 w-full items-center justify-between">
      ...
      <div className="flex gap-1.5">
        ...
        <input
          ...
          className="size-8 rounded-md border bg-neutral-900 text-center font-semibold outline-none ring-blue-500 [appearance:textfield] focus:ring-2 dark:border-neutral-700 [&::-webkit-inner-spin-button]:appearance-none [&::-webkit-outer-spin-button]:appearance-none"
          placeholder="Qt"
          // autoFocus
          min={1}
          inputMode="numeric"
