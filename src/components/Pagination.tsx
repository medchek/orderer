    ...
    >
      <div>
        <ReactPaginate
          ...
          nextLinkClassName="flex h-8 w-8 items-center justify-center rounded-md bg-neutral-300 hover:bg-neutral-200 dark:bg-neutral-950  dark:hover:bg-neutral-800"
          previousLinkClassName="flex h-8 w-8 items-center justify-center rounded-md bg-neutral-300 hover:bg-neutral-200 dark:bg-neutral-950  dark:hover:bg-neutral-800"
          breakLinkClassName="flex h-8 w-8 items-center justify-center rounded-md bg-neutral-950 font-bold  hover:bg-neutral-800"
          pageLinkClassName="flex h-8 w-8 items-center  justify-center rounded-md bg-neutral-300 font-semibold hover:bg-neutral-200 dark:bg-neutral-950 dark:hover:bg-neutral-800"
          disabledLinkClassName="cursor-not-allowed bg-neutral-200! opacity-40 dark:bg-neutral-950! dark:hover:bg-neutral-950!"
