    ...
    <div className="relative flex h-[460px] w-auto animate-pulse flex-col overflow-hidden rounded-lg bg-white transition-all hover:shadow-xl dark:bg-stone-950">
      ...
      <section className="flex grow flex-col justify-between p-2">
        <section className="flex flex-col gap-4">
          <div className="h-6 w-4/5 rounded-md bg-stone-400 dark:bg-stone-800"></div>
          <div className="flex flex-col gap-1">
            <div
              className="h-4 rounded bg-stone-400 dark:bg-stone-800"
              style={{
                width: `${randomNumber(30, 75)}%`, // w-3/4
              }}
            ></div>
            <div
              className="h-4rounded bg-stone-400 dark:bg-stone-800"
              style={{
        ...
        <div className="flex items-center justify-between gap-2">
          <div className="h-8 w-auto grow rounded-md bg-stone-400 dark:bg-stone-800"></div>
          <div className="h-8 w-8 rounded-md bg-stone-400 dark:bg-stone-800"></div>
        </div>
      </section>
    </div>
  );
